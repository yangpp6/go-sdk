...
func NewEcsCreateInstanceApi(client *common.CtyunSender) common.ApiHandler[EcsCreateInstanceRequest, EcsCreateInstanceResponse] {
...
func (v *ecsCreateInstanceApi) Do(ctx context.Context, credential *common.Credential, req *EcsCreateInstanceRequest) (*EcsCreateInstanceResponse, common.CtyunRequestError) {
	// 构建请求
