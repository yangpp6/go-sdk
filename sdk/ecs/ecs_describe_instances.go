...
func NewEcsDescribeInstancesApi(client *common.CtyunSender) common.ApiHandler[EcsDescribeInstancesRequest, EcsDescribeInstancesResponse] {
...
func (v *ecsDescribeInstancesApi) Do(ctx context.Context, credential *common.Credential, req *EcsDescribeInstancesRequest) (*EcsDescribeInstancesResponse, common.CtyunRequestError) {
	// 构建请求
