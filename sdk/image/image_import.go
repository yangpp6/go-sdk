...
func NewImageImportApi(client *common.CtyunSender) common.ApiHandler[ImageImportRequest, ImageImportResponse] {
...
func (v *imageImportApi) Do(ctx context.Context, credential *common.Credential, req *ImageImportRequest) (*ImageImportResponse, common.CtyunRequestError) {
	// 构建请求
