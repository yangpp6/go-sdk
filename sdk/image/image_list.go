...
func NewImageListApi(client *common.CtyunSender) common.ApiHandler[ImageListRequest, ImageListResponse] {
	return &imageListApi{
		client: client,
...
func (v *imageListApi) Do(ctx context.Context, credential *common.Credential, req *ImageListRequest) (*ImageListResponse, common.CtyunRequestError) {
	// 构建请求
	realRequest := v.
