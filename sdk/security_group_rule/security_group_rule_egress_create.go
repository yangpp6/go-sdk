...
func NewSecurityGroupRuleEgressCreateApi(client *common.CtyunSender) common.ApiHandler[SecurityGroupRuleEgressCreateRequest, SecurityGroupRuleEgressCreateResponse] {
...
func (v *securityGroupRuleEgressCreateApi) Do(ctx context.Context, credential *common.Credential, req *SecurityGroupRuleEgressCreateRequest) (*SecurityGroupRuleEgressCreateResponse, common.CtyunRequestError) {
	// 构建请求
